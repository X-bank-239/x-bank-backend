...
import com.example.xbankbackend.generated.tables.Transactions.TransactionsPath;
...
public class BankAccounts extends TableImpl<BankAccountsRecord> {
    ...
    /**
     * The column <code>public.bank_accounts.balance</code>.
     */
    public final TableField<BankAccountsRecord, BigDecimal> BALANCE = createField(DSL.name("balance"), SQLDataType.NUMERIC(19, 4).nullable(false).defaultValue(DSL.field(DSL.raw("0.00"), SQLDataType.NUMERIC)), this, "");

    /**
     * The column <code>public.bank_accounts.currency</code>.
     */
    public final TableField<BankAccountsRecord, CurrencyType> CURRENCY = createField(DSL.name("currency"), SQLDataType.VARCHAR.nullable(false).asEnumDataType(CurrencyType.class), this, "");
    ...
    private transient TransactionsPath _fkReceiver;

    /**
     * Get the implicit to-many join path to the
     * <code>public.transactions</code> table, via the <code>fk_receiver</code>
     * key
     */
    public TransactionsPath fkReceiver() {
        if (_fkReceiver == null)
            _fkReceiver = new TransactionsPath(this, null, Keys.TRANSACTIONS__FK_RECEIVER.getInverseKey());

        return _fkReceiver;
    }

    private transient TransactionsPath _fkSender;

    /**
     * Get the implicit to-many join path to the
     * <code>public.transactions</code> table, via the <code>fk_sender</code>
     * key
     */
    public TransactionsPath fkSender() {
        if (_fkSender == null)
            _fkSender = new TransactionsPath(this, null, Keys.TRANSACTIONS__FK_SENDER.getInverseKey());
